function KERNEL__LOOP_MC_2D____ALGORITHM_19(initialmcs, finalmcs, consider_energy, E, delE, ham, SZS1P1, SZS1P2, SZS1P3, vf, skipmatrix, ConsoleDisplay)
%-------------------------------------------------------------
% WM is randomized for every l;attice site
% Variant of 16
%-------------------------------------------------------------
...
for ms = start:finalmcs
    ...
    constant_centre = MC_Param.constant_centre + rand;
    for pt = 1:nums
        if skipmatrix(pt) == 0
