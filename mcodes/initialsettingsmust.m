% function initialsettingsmust(xmin,xmax,ymin,ymax,xincr,yincr,q,m,zener,nof,txtwriteint,autoconv)
function initialsettingsmust()
...
%     end
    ...
    mkdir(strcat(pwd,'\results','\plots','\microstructure_gbonly_phase03'))
