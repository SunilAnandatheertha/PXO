function [x,y,s,e,secondaryphaseinfo] = im2d(latpar,simpar,slspinfo,icntinfo,clusterinfo)
%<><><><><><><><><><><><><><><><><><>
%<><><><><><><><><><><><><><><><><><>
xmin            = latpar{1}{1};
xmax            = latpar{1}{2};
...
plotlatticeandzpart2d(x,y,latpar,slspinfo,icntinfo,clusterinfo,zslsp,zcnt,zslspc,cntxythetainfo,readfromdisk)
%<><><><><><><><><><><><><><><><><><>
end