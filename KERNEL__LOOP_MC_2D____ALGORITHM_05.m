function KERNEL__LOOP_MC_2D____ALGORITHM_05(initialmcs, finalmcs, E, delE, ham, SZS1P1, SZS1P2, SZS1P3, vf, skipmatrix, ConsoleDisplay)
%-------------------------------------------------------------
...
dlmwrite(strcat(pwd,'\results\datafiles','\','Hamiltonian','.txt'), ham ,'delimiter', '\t')
end