function KERNEL__LOOP_MC_2D____ALGORITHM_17(initialmcs, finalmcs, consider_energy, E, delE, ham, SZS1P1, SZS1P2, SZS1P3, vf, skipmatrix, ConsoleDisplay)
%-------------------------------------------------------------
...
%-------------------------------------------------------------
constant_centre = MC_Param.constant_centre;
